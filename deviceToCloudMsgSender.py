...
class DeviceToCloudMsgSender:
    ...
    def sendD2CMsg(self, deviceId, message):
        ...
        r = requests.post(url, headers={'Authorization': sasToken, 'Content-Type': 'application/json'}, data=message)
        return r.text, r.status_code, message